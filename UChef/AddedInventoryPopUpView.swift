...
private class PopUpWindowView: UIView {
    ...
    init() {
        ...
        // Popup Background
        popupView.backgroundColor = #colorLiteral(red: 0.1490196078, green: 0.3294117647, blue: 0.4862745098, alpha: 1)
        ...
        popupTitle.backgroundColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
        ...
        popupButton.backgroundColor = #colorLiteral(red: 0.9921568627, green: 0.5607843137, blue: 0.3215686275, alpha: 1)
